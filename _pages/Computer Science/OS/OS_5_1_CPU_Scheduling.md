...
tags:
  - OS
date: 2021-05-26
thumbnail: ../../../assets/img/post_img/os_img/FCFS1.png
---

## CPU Burst & I/O Burst
![img](../../../assets/img/post_img/os_img/burst.png)
...
![img](../../../assets/img/post_img/os_img/bound_job.png)
...
>
> ![img](../../../assets/img/post_img/os_img/cpu_scheduling.png)
>
...
* ex 1) 0초 대에서 프로세스들이 간발의 차이로 P1, P2, P3 순으로 들어왔을 때
	![img](../../../assets/img/post_img/os_img/FCFS1.png)

* ex 2) 0초 대에서 프로세스들이 간발의 차이로 P2, P3, P1 순으로 들어왔을 때
	![img](../../../assets/img/post_img/os_img/FCFS2.png)
...
* Nonpreemptive SJF
  ...
  ex) 
	![img](../../../assets/img/post_img/os_img/npSJF.png)
...
* Preemptive SJF (SRTF = Shortest-Remaining-Time-First)
  ...
  ex)
	![img](../../../assets/img/post_img/os_img/pSJF.png)
...
![img](../../../assets/img/post_img/os_img/problem_SJF.png)
...
* Performance
	...
	* q small → context switch 오버헤드가 커진다.
	...
	![img](../../../assets/img/post_img/os_img/RR.png)

...
tags:
  - OS
date: 2021-05-02
thumbnail: ../../../assets/img/post_img/os_img/sync_async.png
---
...
* 동기식 / 비동기식 입출력의 흐름
  ![sync and async](../../../assets/img/post_img/os_img/sync_async.png)
...
* 일반 I/O (좌) & Memory Mapped I/O (우)
  ![I/O comparison](../../../assets/img/post_img/os_img/IO_comp.png)
...
## 프로그램의 실행 (메모리 load) 
* 프로그램 실행 과정
  ![process of program execution](../../../assets/img/post_img/os_img/process_of_program.png)
...
## 커널 주소 공간의 내용
* 물리적 메모리의 커널 영역
  ![kernel of physical memory](../../../assets/img/post_img/os_img/physical_memory.png)
...
* 사용자 프로그램이 사용하는 함수의 종류
	![user program's functions](../../../assets/img/post_img/os_img/user_func.png)
...
* 프로그램의 실행 과정
  ![process of program execution 2](../../../assets/img/post_img/os_img/process_of_program_2.png)

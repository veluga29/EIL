...
tags:
  - OS
date: 2021-05-04
thumbnail: ../../../assets/img/post_img/os_img/status_of_process.png
---
...
* 프로세스의 상태도
  ![status of process](../../../assets/img/post_img/os_img/status_of_process.png)
* 프로세스 상태도 - suspended 상태 추가
  ![status of process plus suspended](../../../assets/img/post_img/os_img/state_of_process_susp.png)
...
* 프로세스 진행과 queue
  ![process queue](../../../assets/img/post_img/os_img/process_queue.png)
* 커널 주소 공간의 자료구조 Queue
  ![queue in kernel](../../../assets/img/post_img/os_img/kernel_queue.png)
...
* PCB의 구조
  ![PCB](../../../assets/img/post_img/os_img/PCB.png)
...
* 문맥 교환 흐름
  ![context switch](../../../assets/img/post_img/os_img/context_switch.png)
...
* 문맥 교환이 일어나는 경우와 아닌 경우
  ![case of context switch](../../../assets/img/post_img/os_img/case_of_context_switch.png)

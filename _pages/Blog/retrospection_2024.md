...
## 개발 공부
사실 올 한해 공부했던 모든 것들이 너무 유익했다. FastAPI 생태계에 있을 때는 어려웠던 레퍼런스 천국을 자바 생태계에서 경험했다.
선별한 강의와 책을 보면서 예제 코드를 백문이 불여일타하고 이론은 학습기록용 블로그에 정리하고 있다.
...
올 한 해 읽은 기술 서적들이다. 사실 읽고 싶은 책이 더 많았는데 시간이 참 빠르게 지나간다.
...
### 자격증
올 해 SQLD와 정보처리기사 2개를 합격했다.
시간이 길어지는만큼 기본적인 것들은 최소한의 시간으로 그냥 가져가자고 목표했다. 
어떤 관점에서는 그냥 넘어갈 수도 있지만 좋은 결정이었다고 생각한다.
...
## 맺음말
프로페셔널한게 중요하다고 생각해 보낸 시간들이다. 올 해는 기여할 수 있는 곳을 찾고 몰입할 수 있도록 다음 단계를 밟아야겠다.
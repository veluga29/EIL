...
- 기본 사용법: 스프링 데이터 JPA의 **사용자 정의 리포지토리** 기능 활용
	![combination_of_spring_data_jpa_and_querydsl](../../../assets/img/post_img/querydsl_img/combination_of_spring_data_jpa_and_querydsl.png)
	- 이 경우, `MemberRepositoryImpl`은 **`MemberRepositoryCustomImpl`** 도 가능 (**권장**)
	- 순서
		- 사용자 정의 인터페이스 작성
			```java
